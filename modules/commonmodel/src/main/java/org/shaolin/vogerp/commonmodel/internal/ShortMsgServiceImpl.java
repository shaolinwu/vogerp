...
//        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
	...
	public QuerySendDetailsResponse querySendDetails(String phoneNumber, String bizId) throws ClientException {
        ...
        //hint 此处可能会抛出异常，注意catch
        QuerySendDetailsResponse queryResponse = acsClient.getAcsResponse(request);
        logger.info("QuerySendDetailsResponse Code=" + queryResponse.getCode() + ", Message=" + queryResponse.getMessage());
        int i = 0;
        for(QuerySendDetailsResponse.SmsSendDetailDTO smsSendDetailDTO : queryResponse.getSmsSendDetailDTOs())
        {
...
//        System.out.println("TotalCount=" + queryResponse.getTotalCount());
//        System.out.println("RequestId=" + queryResponse.getRequestId());
