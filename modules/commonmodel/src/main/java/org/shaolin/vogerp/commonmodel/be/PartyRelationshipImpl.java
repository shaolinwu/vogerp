...
public class PartyRelationshipImpl  implements org.shaolin.vogerp.commonmodel.be.IPartyRelationship
{
    ...
    {
        return "org.shaolin.vogerp.commonmodel.be.PartyRelationship";
    }

    public PartyRelationshipImpl()
    {
   ...
   /**
     *  help is not available
     */    
    protected PartyRelationType type = PartyRelationType.NOT_SPECIFIED;
    
    protected int typeInt = PartyRelationType.NOT_SPECIFIED.getIntValue();
   ...
   /**
     ...
     *  @return type
     */
    public PartyRelationType getType() {
        return type;
    }
...
/**
     ...
     *  set type
     */
    public void setType(PartyRelationType type) {
        this.type = type;
    ...
    private void setTypeInt(int intValue) {
        ...
        if (typeInt != type.getIntValue()) {
            type = (PartyRelationType)ceService.getConstantEntity(PartyRelationType.ENTITY_NAME).getByIntValue(typeInt);
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof org.shaolin.vogerp.commonmodel.be.PartyRelationshipImpl))
            return false;
        org.shaolin.vogerp.commonmodel.be.PartyRelationshipImpl o = (org.shaolin.vogerp.commonmodel.be.PartyRelationshipImpl)obj;
    ...
    public  String  toString() {
        ...
        aBuf.append("org.shaolin.vogerp.commonmodel.be.PartyRelationship");
    ...
    public List<MemberType> getMemberList() {
        ...
        typeTargetEntity.setEntityName("org.shaolin.vogerp.commonmodel.ce.PartyRelationType");
    ...
    public IPartyRelationship createEntity ()
    {
        return new PartyRelationshipImpl();
    }
