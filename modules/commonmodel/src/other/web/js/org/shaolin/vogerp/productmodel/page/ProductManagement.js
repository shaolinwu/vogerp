...
function org_shaolin_vogerp_productmodel_page_ProductManagement(json)
{
    ...
    Form.openProductCharacteristic = org_shaolin_vogerp_productmodel_page_ProductManagement_openProductCharacteristic;
...
/* Other_Func_LAST:org_shaolin_vogerp_productmodel_page_ProductManagement */
    ...
    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_productmodel_page_ProductManagement_openProductCharacteristic(eventsource,event) {/* Gen_First:org_shaolin_vogerp_productmodel_page_ProductManagement_openProductCharacteristic */

        // cal ajax function. 

        UIMaster.triggerServerEvent(UIMaster.getUIID(eventsource),"openProductCharacteristic432432",UIMaster.getValue(eventsource),this.__entityName);

        var UIEntity = this;
    }/* Gen_Last:org_shaolin_vogerp_productmodel_page_ProductManagement_openProductCharacteristic */
