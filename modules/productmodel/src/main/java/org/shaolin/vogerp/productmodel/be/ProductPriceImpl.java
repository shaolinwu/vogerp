...
public class ProductPriceImpl  implements org.shaolin.vogerp.productmodel.be.IProductPrice
{
    ...
    {
        return "org.shaolin.vogerp.productmodel.be.ProductPrice";
    }
   ...
   /**
     *  help is not available
     */    
    protected PriceType type = PriceType.NOT_SPECIFIED;
    
    protected int typeInt = PriceType.NOT_SPECIFIED.getIntValue();
    ...
    private void setTypeInt(int intValue) {
        ...
        if (typeInt != type.getIntValue()) {
            type = (PriceType)ceService.getConstantEntity(PriceType.ENTITY_NAME).getByIntValue(typeInt);
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof org.shaolin.vogerp.productmodel.be.ProductPriceImpl))
            return false;
        org.shaolin.vogerp.productmodel.be.ProductPriceImpl o = (org.shaolin.vogerp.productmodel.be.ProductPriceImpl)obj;
    ...
    public  String  toString() {
        ...
        aBuf.append("org.shaolin.vogerp.productmodel.be.ProductPrice");
    ...
    public List<MemberType> getMemberList() {
        ...
        org.shaolin.bmdp.datamodel.bediagram.IntType exceedAmountBEType = new org.shaolin.bmdp.datamodel.bediagram.IntType();
    
        //MemberType Define for exceedAmount
        member = new MemberType();
        member.setName("exceedAmount");
        member.setDescription("null");
        member.setType(exceedAmountBEType);
        memberTypeList.add(member);
        ...
        typeTargetEntity.setEntityName("org.shaolin.vogerp.productmodel.ce.PriceType");
    ...
    public IProductPrice createEntity ()
    {
        return new ProductPriceImpl();
    }
