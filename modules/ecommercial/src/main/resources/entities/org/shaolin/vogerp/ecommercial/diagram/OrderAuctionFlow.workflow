...
<ns2:Workflow xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	xsi:schemaLocation="">
	<entityName>org.shaolin.vogerp.ecommercial.diagram.OrderAuctionFlow</entityName>
	<systemVersion>0</systemVersion>
	<description>抢单流程</description>
	<ns2:conf>
		...
		<ns2:start-node name="init">
			<ns2:process>
			 <ns2:var name="goldenOrder" category="BusinessEntity" scope="InOut">
				...
				<ns2:expression>
					<expressionString>{
						System.out.println("initial the workflow session on start node with init data: " + $goldenOrder);
						@flowContext.save($goldenOrder);//assign task id to sales order.
						}
					</expressionString>
				</ns2:expression>
			</ns2:process>
