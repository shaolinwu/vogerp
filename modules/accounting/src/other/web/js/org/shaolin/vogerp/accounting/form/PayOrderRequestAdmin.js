...
function org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin(json)
{
    ...
    {
        /* Construct_FIRST:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin */
        /* Construct_LAST:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin */
    };
    ...
    Form.Cancel = org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_Cancel;

    Form.invokeDynamicFunction = org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_invokeDynamicFunction;

    Form.__entityName="org.shaolin.vogerp.accounting.form.PayOrderRequestAdmin";
...
/* Other_Func_FIRST:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin */
/* Other_Func_LAST:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin */

    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_confirmedWithdraw(eventsource,event) {/* Gen_First:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_confirmedWithdraw */
        var o = this;
        var UIEntity = this;
    ...
    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_cancelWithdraw(eventsource,event) {/* Gen_First:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_cancelWithdraw */
        var o = this;
        var UIEntity = this;

        // cal ajax function. 

        UIMaster.triggerServerEvent(UIMaster.getUIID(eventsource),"cancelWithdraw-20170519-231757",UIMaster.getValue(eventsource),o.__entityName);
    }/* Gen_Last:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_cancelWithdraw */


    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_Cancel(eventsource,event) {/* Gen_First:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_Cancel */
        var o = this;
        var UIEntity = this;
    ...
    }/* Gen_Last:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_Cancel */


    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_invokeDynamicFunction(eventsource,event) {/* Gen_First:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_invokeDynamicFunction */
        var o = this;
        var UIEntity = this;
    ...
    }/* Gen_Last:org_shaolin_vogerp_accounting_form_PayOrderRequestAdmin_invokeDynamicFunction */
