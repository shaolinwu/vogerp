...
function org_shaolin_vogerp_accounting_form_InvoiceItemTable(json)
{
    ...
    Form.invokeDynamicFunction = org_shaolin_vogerp_accounting_form_InvoiceItemTable_invokeDynamicFunction;
...
{this.itemTable.syncBodyDataToServer();}
    ...
    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_accounting_form_InvoiceItemTable_invokeDynamicFunction(eventsource,event) {/* Gen_First:org_shaolin_vogerp_accounting_form_InvoiceItemTable_invokeDynamicFunction */
        ...
        var UIEntity = this;
    }/* Gen_Last:org_shaolin_vogerp_accounting_form_InvoiceItemTable_invokeDynamicFunction */
