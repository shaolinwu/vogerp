...
public class AcctSchema extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBFATEEXPORT = "oBFATEExport";
    ...
    public AcctSchema() {
        ...
        setDefaultValue(PROPERTY_OBFATEEXPORT, false);
    ...
    public Boolean isOBFATEExport() {
        return (Boolean) get(PROPERTY_OBFATEEXPORT);
    }

    public void setOBFATEExport(Boolean oBFATEExport) {
        set(PROPERTY_OBFATEEXPORT, oBFATEExport);
    }
