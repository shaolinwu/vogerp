/*
 *
 * This file is automatically generated on Sun Jul 19 23:56:27 CST 2015
 */
...
public class InBalanceSheetImpl  implements org.shaolin.vogerp.accounting.be.IInBalanceSheet
{
    ...
    {
        return "org.shaolin.vogerp.accounting.be.InBalanceSheet";
    }

    public InBalanceSheetImpl()
    {
...
/**
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof org.shaolin.vogerp.accounting.be.InBalanceSheetImpl))
            return false;
        org.shaolin.vogerp.accounting.be.InBalanceSheetImpl o = (org.shaolin.vogerp.accounting.be.InBalanceSheetImpl)obj;
    ...
    public  String  toString() {
        ...
        aBuf.append("org.shaolin.vogerp.accounting.be.InBalanceSheet");
    ...
    public List<MemberType> getMemberList() {
        ...
        org.shaolin.bmdp.datamodel.bediagram.LongType transIdBEType = new org.shaolin.bmdp.datamodel.bediagram.LongType();
    
        //MemberType Define for transId
        member = new MemberType();
        member.setName("transId");
        member.setDescription("null");
        member.setType(transIdBEType);
        memberTypeList.add(member);
            
        return memberTypeList;
    }
    
    public IInBalanceSheet createEntity ()
    {
        return new InBalanceSheetImpl();
    }
